<template>
    <div class="bg-primary text-white px-5 pt-5 pb-8 text-2xl tracking-wider py-4 flex justify-between relative">
        <div class="absolute inset-0 opacity-10 pointer-none"
